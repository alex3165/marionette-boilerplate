...
},{"./modules/main/module":28,"backbone":"backbone","backbone.marionette":"backbone.marionette","jquery":"jquery"}],25:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../models/article":27,"backbone":"backbone"}],26:[function(require,module,exports){
var Backbone = require('backbone');
var Marionette = require('backbone.marionette');
...
},{"../../../datas.json":1,"./collections/articles":25,"./views/cover/cover":31,"./views/footer/footer":33,"./views/header/header":35,"backbone":"backbone","backbone.marionette":"backbone.marionette"}],27:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./controller":26,"./router":29,"./views/layout/layout":37,"backbone.marionette":"backbone.marionette"}],29:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"backbone.marionette":"backbone.marionette"}],30:[function(require,module,exports){
...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	<article class=\"blog-preview__article\" data-id=\""
    ...
    + "\">\n\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.slider : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    ...
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.gallery : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\n	</article>\n";
},"2":function(container,depth0,helpers,partials,data) {
    var stack1;

  return "			<ul class=\"slider\" data-slider>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.slider : depth0),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "			</ul>\n";
  ...
  return "			<div class=\"gallery\">\n				<ul class=\"gallery__list\" data-gallery>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.gallery : depth0),{"name":"each","hash":{},"fn":container.program(6, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "				</ul>\n			</div>\n";
},"6":function(container,depth0,helpers,partials,data) {
    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "						<li class=\"gallery__item\"><a href=\""
    + alias4(((helper = (helper = helpers.full || (depth0 != null ? depth0.full : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"full","hash":{},"data":data}) : helper)))
    + "\"><img src=\""
...
},{"./cover.hbs":30,"backbone.marionette":"backbone.marionette","magnific-popup":22,"slick-carousel":23}],32:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
...
},{"./footer.hbs":32,"backbone.marionette":"backbone.marionette"}],34:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
},{"./header.hbs":34,"backbone.marionette":"backbone.marionette","jquery":"jquery"}],36:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
...
},{"./layout.hbs":36,"backbone.marionette":"backbone.marionette"}]},{},[24]);
